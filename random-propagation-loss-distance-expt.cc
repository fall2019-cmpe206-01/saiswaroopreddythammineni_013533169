...
int main (int argc, char *argv[])
{
...

  {
    ...
    // ADDED for lognormal here
	Ptr<<LogNormalPropagationLossModel> logNormalPropagation = CreateObject<<LogNormalPropagationLossModel> ();
	logNormalPropagation->SetAttribute("RandomVariable", StringValue ("ns3::NormalRandomVariable[Mean=0|Variance=2]"));
    logNormalPropagation->SetAttribute("Exponent",DoubleValue (3));
